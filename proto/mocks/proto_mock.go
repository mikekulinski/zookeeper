...
// Source: github.com/mikekulinski/zookeeper/proto (interfaces: Zookeeper_MessageClient,Zookeeper_MessageServer,ZookeeperClient)
//
// Generated by this command:
//
//	mockgen -destination mocks/proto_mock.go github.com/mikekulinski/zookeeper/proto Zookeeper_MessageClient,Zookeeper_MessageServer,ZookeeperClient
//
...
// MockZookeeper_MessageServer is a mock of Zookeeper_MessageServer interface.
type MockZookeeper_MessageServer struct {
	ctrl     *gomock.Controller
	recorder *MockZookeeper_MessageServerMockRecorder
}

// MockZookeeper_MessageServerMockRecorder is the mock recorder for MockZookeeper_MessageServer.
type MockZookeeper_MessageServerMockRecorder struct {
	mock *MockZookeeper_MessageServer
}

// NewMockZookeeper_MessageServer creates a new mock instance.
func NewMockZookeeper_MessageServer(ctrl *gomock.Controller) *MockZookeeper_MessageServer {
	mock := &MockZookeeper_MessageServer{ctrl: ctrl}
	mock.recorder = &MockZookeeper_MessageServerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockZookeeper_MessageServer) EXPECT() *MockZookeeper_MessageServerMockRecorder {
	return m.recorder
}

// Context mocks base method.
func (m *MockZookeeper_MessageServer) Context() context.Context {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Context")
	ret0, _ := ret[0].(context.Context)
	return ret0
...
// Context indicates an expected call of Context.
func (mr *MockZookeeper_MessageServerMockRecorder) Context() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Context", reflect.TypeOf((*MockZookeeper_MessageServer)(nil).Context))
}

// Recv mocks base method.
func (m *MockZookeeper_MessageServer) Recv() (*zookeeper.ZookeeperRequest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*zookeeper.ZookeeperRequest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Recv indicates an expected call of Recv.
func (mr *MockZookeeper_MessageServerMockRecorder) Recv() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Recv", reflect.TypeOf((*MockZookeeper_MessageServer)(nil).Recv))
}

// RecvMsg mocks base method.
func (m *MockZookeeper_MessageServer) RecvMsg(arg0 any) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RecvMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// RecvMsg indicates an expected call of RecvMsg.
func (mr *MockZookeeper_MessageServerMockRecorder) RecvMsg(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecvMsg", reflect.TypeOf((*MockZookeeper_MessageServer)(nil).RecvMsg), arg0)
}

// Send mocks base method.
func (m *MockZookeeper_MessageServer) Send(arg0 *zookeeper.ZookeeperResponse) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// Send indicates an expected call of Send.
func (mr *MockZookeeper_MessageServerMockRecorder) Send(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockZookeeper_MessageServer)(nil).Send), arg0)
}

// SendHeader mocks base method.
func (m *MockZookeeper_MessageServer) SendHeader(arg0 metadata.MD) error {
	m.ctrl.T.Helper()
...
func (mr *MockZookeeper_MessageServerMockRecorder) SendHeader(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendHeader", reflect.TypeOf((*MockZookeeper_MessageServer)(nil).SendHeader), arg0)
}

// SendMsg mocks base method.
func (m *MockZookeeper_MessageServer) SendMsg(arg0 any) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// SendMsg indicates an expected call of SendMsg.
func (mr *MockZookeeper_MessageServerMockRecorder) SendMsg(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMsg", reflect.TypeOf((*MockZookeeper_MessageServer)(nil).SendMsg), arg0)
}

// SetHeader mocks base method.
func (m *MockZookeeper_MessageServer) SetHeader(arg0 metadata.MD) error {
	m.ctrl.T.Helper()
...
func (mr *MockZookeeper_MessageServerMockRecorder) SetHeader(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetHeader", reflect.TypeOf((*MockZookeeper_MessageServer)(nil).SetHeader), arg0)
}

// SetTrailer mocks base method.
func (m *MockZookeeper_MessageServer) SetTrailer(arg0 metadata.MD) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetTrailer", arg0)
}

// SetTrailer indicates an expected call of SetTrailer.
func (mr *MockZookeeper_MessageServerMockRecorder) SetTrailer(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetTrailer", reflect.TypeOf((*MockZookeeper_MessageServer)(nil).SetTrailer), arg0)
}
